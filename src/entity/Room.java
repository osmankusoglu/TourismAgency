...
public class Room {
    ...
    public boolean isRoom_cash_box() {
        return room_cash_box;
    }

    public void setRoom_cash_box(boolean room_cash_box) {
        this.room_cash_box = room_cash_box;
    }
